    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;width:100%">' +
        ...
        getText: function () {
            ...
            this.$dropdown.find('.city-select')
                .each(function () {
                    ...
                    if (item) {
                        text += ($(this).hasClass('province') ? '' : '/') + '<span class="select-item '+type+'" data-count="' +
        ...
        output: function (type) {
            ...
            districts = $.isNumeric(code) ? this.remoteLoadData(type,code) : null;//判断是否应该去远程加载数据
